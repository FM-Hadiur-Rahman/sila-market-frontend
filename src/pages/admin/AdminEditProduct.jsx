  ...
  useEffect(() => {
    const loadProduct = async () => {
      try {
        ...
        const categoryExists = DEFAULT_CATEGORIES.includes(product.category);

        setForm({
          name: product.name || "",
          category: categoryExists ? product.category : "__new__",
          newCategory: categoryExists ? "" : product.category || "",
